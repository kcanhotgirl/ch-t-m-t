...
function createGift() {
    ...
    const messages = [
        '🎁 Chúc mừng! Giáng sinh này bạn nhận được anh ny rất cute',
        '🎄 Chúc em yêu có một giáng sinh an lành!',
        '⭐ Năm mới hạnh phúc bên nhau!',
        '🎅 Ho Ho Ho! Nhận quà rồi đi đón giáng sinh cùng anh nào',
        '❤️Chúc em yêu luôn hạnh phúc!',
    ];
